...
import { submitLeadInquiry } from "@/lib/lead-forms";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Contact · Nordwell" },
      {
        ...
        content:
          "Start a project with a boutique studio for websites, landing pages and AI automation.",
      },
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr]">
              <div className="space-y-4">
                <ContactCard
                  ...
                  sub="Calendly · same-week availability"
                  href="#"
                />
                <ContactCard
                  ...
                  >
                    ...
                    <div className="mt-4 grid gap-4 sm:grid-cols-2">
                      ...
                      <Field
                        label="Industry"
                        name="industry"
                        placeholder="e.g. Fintech, DTC, Health"
                      />
                    </div>
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <select
                          name="budget"
                          className="w-full rounded-2xl border border-border bg-background px-4 py-3 text-[14px] outline-none"
                        >
...
function ContactCard({
  ...
  return (
    <a
      href={href}
      className="group flex items-center justify-between rounded-2xl border border-border bg-card px-5 py-4 transition-colors hover:bg-accent/40"
    >
