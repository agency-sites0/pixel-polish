...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nordwell is a small, senior studio building websites, landing pages and AI automation for ambitious teams. Meet the studio, our values and how we work." },
      { property: "og:title", content: "About · Nordwell" },
      { property: "og:description", content: "A small, senior studio for websites, landing pages and AI automation." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://elevated-experience-co.lovable.app/about" },
    ],
    links: [{ rel: "canonical", href: "https://elevated-experience-co.lovable.app/about" }],
  }),
  component: AboutPage,
});

const values = [
  { t: "Craft over volume", b: "We take on eight to twelve engagements a year — and give each the attention it deserves." },
  { t: "Outcomes over outputs", b: "The deliverable isn't a Figma file. It's a number that changes for your business." },
  { t: "Direct over polished", b: "You'll get honest reads on what's working, what isn't, and what we'd do in your shoes." },
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground antialiased">
      ...
      <main className="pt-32">
          ...
          <div className="mx-auto max-w-6xl px-5">
            ...
            <Reveal i={2}>
              <p className="mt-8 max-w-2xl text-lg text-muted-foreground">
                Nordwell is a boutique studio of senior designers, engineers and strategists. We build the marketing sites, landing pages and AI automation that turn traffic into revenue — for a small handful of ambitious clients each year.
              </p>
            </Reveal>
          </div>
        </section>
        ...
        <section className="border-y border-border bg-muted/30 py-24">
          <div className="mx-auto max-w-6xl px-5">
            <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr]">
              <SectionHeader align="left" eyebrow="Our story" title="Started as freelancers. Stayed small on purpose." />
              <div className="space-y-6 text-base text-foreground/80">
                <p>We started as two freelancers taking on the projects the big agencies wouldn't. Ten years later, we're still small. That's the point.</p>
                <p>Every project is led by a partner. Every deliverable is reviewed by the same eyes that quoted it. No juniors learning on your budget, no account managers between you and the people doing the work.</p>
                <p>We turn down more work than we take. That's how we keep the standards, the pace and the honesty that our clients hire us for.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="border-y border-border bg-muted/30 py-24">
          <div className="mx-auto max-w-6xl px-5">
            <SectionHeader align="left" eyebrow="Behind the scenes" title="The quiet operational stuff that changes outcomes." />
            <ul className="mt-12 grid gap-3 sm:grid-cols-2">
              {behind.map((b, i) => (
                <Reveal key={b} i={i}>
                  <li className="flex items-start gap-3 rounded-2xl border border-border bg-card p-5 text-sm text-foreground/80">
                    <span className="mt-0.5 grid size-5 shrink-0 place-items-center rounded-full bg-foreground text-background text-[10px]">✓</span>
                    {b}
                  </li>
                </Reveal>
              ))}
