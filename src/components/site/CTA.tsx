            ...
            <div className="relative grid gap-10 p-10 sm:p-16 lg:grid-cols-[1.4fr_1fr] lg:items-end">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-background/20 bg-background/10 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.14em] text-background/80 backdrop-blur">
                  ...
                  Accepting 3 Series B+ partnerships this quarter
                </div>
                ...
                <p className="mt-5 max-w-xl text-base text-background/70 sm:text-lg">
                  Let's uncover the one change most likely to impact your revenue this quarter. We'll share what's working for teams like yours and map the path forward. No pitch, no follow-up dance.
                </p>
              </div>
              <div className="flex flex-col gap-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <div className="text-sm font-semibold">Schedule a 45-min session</div>
                      <div className="text-xs text-muted-foreground">Same week · senior strategist</div>
                    </div>
                  </div>
                ...
                >
                  <div className="text-left">
                    ...
                    <div className="text-xs text-background/60">hello@ascent.studio</div>
                  </div>
                  <ArrowUpRight className="size-4 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                </a>
              </div>
